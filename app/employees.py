        ...
        try:
            with psycopg2.connect(
                ...
                with conn.cursor(cursor_factory=DictCursor) as cursor:
                    ...
                    WHERE employee_id = %s;                    
                    """, (employee_id,)) # the comma after the variable employee_id is because I need to input a tuple as an argument, and without the comma is just an expression with brackets
                    ...
                    self.base_salary = row['base_salary']
